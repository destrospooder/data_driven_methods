...
URI = uri_helper.uri_from_env(default='radio://0/80/2M/E7E7E7E7F1')
...
def move_box_limit(scf):
    with PositionHlCommander(scf, x=0.0, y=0.0, z=0.0, default_velocity=0.5, default_height=0.5, controller=None, default_landing_height=0.0) as mc:
        mc.go_to(0, 0, 1.5)
        time.sleep(1)
...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        logconf.data_received_cb.add_callback(log_pos_callback) # Add this line
        scf.cf.log.add_config(logconf)
